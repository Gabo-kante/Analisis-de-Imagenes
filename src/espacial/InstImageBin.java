 ...
 * @author gabri
 */
public class InstImageBin {
    
    private BufferedImage imagenGrisesOriginal;
  

    public InstImageBin(Object imagenGrises) {
      
         if (imagenGrises instanceof InstImageBin){
           Histogrises aux = (Histogrises)imagenGrises;
           // modificar la imagen 
        ...
        if (imagenGrises instanceof Image){
           ...
           Histogrises aux = new Histogrises(auxImagen);
